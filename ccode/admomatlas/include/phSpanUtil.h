...
phObjmaskMerge(
	       ...
	       int dy,			/* Shift input by this amount before
					   merging */
	       int dx
	       );
OBJMASK *
...
OBJMASK *
phObjmaskNotIntersectionObjmaskChain(const OBJMASK *obj, 
				     const CHAIN *mask2);
OBJMASK *
phObjmaskNotIntersectionObjmask(const OBJMASK *om1, 
				const OBJMASK *om2);
void
