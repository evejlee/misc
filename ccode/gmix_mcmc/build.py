...
test_turb_sources = ['test/test-turb','gauss','gmix','image','gmix_mcmc','gmix_image','mca','admom','randn']
test_dev_sources = ['test/test-dev','gauss','gmix','image','gmix_mcmc','gmix_image','mca','admom','randn']
