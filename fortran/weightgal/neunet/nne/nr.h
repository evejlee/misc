...
int cyclic(Vec_I_DP &a, Vec_I_DP &b, Vec_I_DP &c, const DP alpha,
	const DP beta, Vec_I_DP &r, Vec_O_DP &x);
int cyclic(Vec_I_CPLX_DP &a, Vec_I_CPLX_DP &b, Vec_I_CPLX_DP &c, const CPLX alpha,
	   const CPLX beta, Vec_I_CPLX_DP &r, Vec_O_CPLX_DP &x);
...
void hpsel(Vec_I_DP &arr, Vec_O_INT &indx);
...
int tridag(Vec_I_DP &a, Vec_I_DP &b, Vec_I_DP &c, Vec_I_DP &r, Vec_O_DP &u);
int tridag(Vec_I_CPLX_DP &a, Vec_I_CPLX_DP &b, Vec_I_CPLX_DP &c, Vec_I_CPLX_DP &r, Vec_O_CPLX_DP &u);
