...
syn keyword idlangStatement return continue mod break
syn keyword idlangStatement compile_opt forward_function goto
syn keyword idlangStatement common end 
syn keyword idlangStatement inherits on_ioerror

syn keyword idlangConditional if else then for while case of switch
syn keyword idlangConditional endcase endelse endfor endswitch
syn keyword idlangConditional do begin endif endrep endwhile repeat until
